...
import { PartitionOutlined, PicCenterOutlined, ZoomInOutlined, ZoomOutOutlined } from '@ant-design/icons';
      ...
      <VisibilitySensor onChange={onViewportChange}>
        <Resizeable isEditable={isEditable} width={width} height={height} maxWidth={maxWidth} onChangeEnd={onResize}>
          ...
          <div className={"toolbarWrap"}>
            <Space>
              <Button type="text" size="small" onClick={center} icon={<PicCenterOutlined />} />
              <Button type="text" size="small" onClick={zoomOut} icon={<ZoomOutOutlined />} />
              <Button type="text" size="small" onClick={zoomIn} icon={<ZoomInOutlined />} />
            </Space>
          </div>
        </Resizeable>
      </VisibilitySensor>
